  ...
  return (
    <footer className="bg-midnight text-white">
      <div className="container-page grid gap-8 py-12 sm:gap-10 sm:py-14 md:grid-cols-[1fr_auto] md:items-end">
        <div>
          <Logo inverse />
          <p className="mt-5 max-w-md font-display text-2xl font-bold leading-tight tracking-[-0.04em] text-white/90">Tu próximo viaje empieza con una buena oferta.</p>
          <p className="mt-3 max-w-lg text-sm leading-6 text-white/50">UR WAY encuentra y compara ofertas de vuelo. No somos una agencia ni emitimos boletos: te llevamos al proveedor cuando decides reservar.</p>
        </div>
        <nav className="grid gap-3 text-sm text-white/60 min-[390px]:flex min-[390px]:flex-wrap min-[390px]:gap-x-7 min-[390px]:gap-y-3" aria-label="Navegación al pie">
          ...
          <Link href="/#newsletter" className="transition hover:text-white">Recibir ofertas</Link>
        </nav>
      </div>
